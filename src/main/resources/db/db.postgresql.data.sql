...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070100','我在这里', 'http://code.google.com/p/dragon-bc', 'i0608' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070100','GitHub', 'https://github.com/rongjihuang/bc-demo', 'i0607' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070200','开源中国社区', 'http://www.oschina.net', 'i0606' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070300','ITeye', 'http://www.iteye.com', 'i0605' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070400','cnBeta', 'http://www.cnbeta.com', 'i0604' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '070500','图片资源', 'http://www.iconarchive.com', 'i0509' from BC_IDENTITY_RESOURCE m where m.order_='070000';
-- 资源:常用链接/微博
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
    select NEXTVAL('CORE_SEQUENCE'), 0, false, 1, m.id, '073900','微博', null, 'i0508' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '073901','新浪微博', 'http://weibo.com', 'i0508' from BC_IDENTITY_RESOURCE m where m.order_='073900';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '073902','腾讯微博', 'http://t.qq.com', 'i0507' from BC_IDENTITY_RESOURCE m where m.order_='073900';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '073903','网易微博', 'http://t.163.com', 'i0506' from BC_IDENTITY_RESOURCE m where m.order_='073900';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '073904','搜狐微博', 'http://t.sohu.com', 'i0508' from BC_IDENTITY_RESOURCE m where m.order_='073900';
-- 资源:常用链接/搜索引擎
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
    select NEXTVAL('CORE_SEQUENCE'), 0, false, 1, m.id, '074000','搜索引擎', null, 'i0100' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '074001','谷歌', 'http://www.google.com.hk', 'i0204' from BC_IDENTITY_RESOURCE m where m.order_='074000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '074002','必应', 'http://cn.bing.com', 'i0204' from BC_IDENTITY_RESOURCE m where m.order_='074000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '074003','百度', 'http://www.baidu.com', 'i0205' from BC_IDENTITY_RESOURCE m where m.order_='074000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 3, m.id, '074004','中国雅虎', 'http://search.cn.yahoo.com', 'i0204' from BC_IDENTITY_RESOURCE m where m.order_='074000';
-- 资源:常用链接/功能演示
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
    select NEXTVAL('CORE_SEQUENCE'), 0, false, 1, m.id, '074100','功能演示', null, 'i0100' from BC_IDENTITY_RESOURCE m where m.order_='070000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 2, m.id, '074101','选择4Actor', '/bc-test/selectIdentity', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 2, m.id, '074102','选择日期', '/bc-test/datepicker', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 2, m.id, '074103','附件设计', '/bc/attach/design', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 2, m.id, '074104','选择4BS', '/bs-test/select', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
-- 资源:常用链接/功能演示/报表演示
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
...
-- 平台模块
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  1, null, '020000','平台模块', null, 'i0403');
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, 2, m.id, '020100','公告信息', '/bc/bulletins/paging', 'i0406' from BC_IDENTITY_RESOURCE m where m.order_='020000';
...
-- 插入组织架构管理角色数据
insert into BC_IDENTITY_ROLE (ID,STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'0002', 'BC_ORGANIZE','组织架构管理');
insert into BC_IDENTITY_ROLE_RESOURCE (RID,SID) 
...
-- 插入选项管理员角色数据
insert into BC_IDENTITY_ROLE (ID,STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'0003', 'BC_OPTION','选项管理');
insert into BC_IDENTITY_ROLE_RESOURCE (RID,SID) 
...
-- 插入公告管理员角色数据
insert into  BC_IDENTITY_ROLE (ID,STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'0004', 'BC_BULLETIN','公告管理');
insert into BC_IDENTITY_ROLE_RESOURCE (RID,SID) 
...
-- 插入用户反馈管理角色数据
insert into  BC_IDENTITY_ROLE (ID,STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'0005', 'BC_FEEDBACK','反馈管理');
insert into BC_IDENTITY_ROLE_RESOURCE (RID,SID) 
...
-- 插入附件管理角色数据
insert into  BC_IDENTITY_ROLE (ID,STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'0006', 'BC_ATTACH','附件管理');
insert into BC_IDENTITY_ROLE_RESOURCE (RID,SID) 
...
-- 插入职务数据
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0100','职员');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0101','董事长');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0201','总经理');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0202','副总经理');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0203','主管');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0204','主任');
insert into BC_IDENTITY_DUTY (ID,CODE, NAME) values(NEXTVAL('CORE_SEQUENCE'), '0205','副主任');
...
-- 插入单位数据
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 1, 'D00','总公司', '00000000','zonggongsi',NULL,NULL);
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 1, 'D01','分公司1', '01000000','fengongsi1','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='D00' and af.code='D01';
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 1, 'D02','分公司2', '02000000','fengongsi2','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='D00' and af.code='D02';

-- 插入部门数据
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 2, 'B01','办公室', '00010000','bangongshi','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='D00' and af.code='B01';
    
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 2, 'B02','财务部', '00020000','caiwubu','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='D00' and af.code='B02';
    
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 2, 'B03','信息中心', '00030000','xinxizhongxin','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='D00' and af.code='B03';

insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 2, 'B0301','子部门1', '00030100','zibumen1','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='B0301';
    
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 2, 'B0302','子部门2', '00030200','zibumen2','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
     select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='B0302';
    
-- 插入人员数据
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'dongshizhang','董事长', '00000001','董事长','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'zongjingli','总经理', '00000002','zongjingli','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID)  
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'fuzongjingli','副总经理', '00000003','fuzongjingli','[1]D00','总公司');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID)  
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'xiaoming','小明', '00010001','xiaoming','[1]D00/[2]B01','总公司/办公室');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'xiaohong','小红', '00010002','xiaohong','[1]D00/[2]B01','总公司/办公室');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'xiaojun','小军', '00020001','xiaojun','[1]D00/[2]B02','总公司/财务部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'admin','超级管理员', '00030001','chaojiguanliyuan','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_, PY,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 4, 'dragon','黄荣基', '00030002', 'huangrongji','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
-- 插入岗位数据
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G_ADMIN','超级管理岗', '0000','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G_ADMIN'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9901','测试岗位1', '9901','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9901'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9902','测试岗位2', '9902','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9902'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9903','测试岗位3', '9903','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9903'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9904','测试岗位4', '9904','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9904'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9905','测试岗位5', '9905','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9905'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9906','测试岗位6', '9906','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='B03' and af.code='G9906'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(NEXTVAL('CORE_SEQUENCE'), 'uid', 0, false, 3, 'G9907','测试岗位7', '9907','[1]D00/[2]B03','总公司/信息中心');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
insert into BC_DESKTOP_SHORTCUT (ID,STATUS_,INNER_,ORDER_,STANDALONE,NAME,URL,ICONCLASS,SID,AID) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, '1001', false, name, url, iconclass, id, 0 from BC_IDENTITY_RESOURCE where name='个性化设置';
insert into BC_DESKTOP_SHORTCUT (ID,STATUS_,INNER_,ORDER_,STANDALONE,NAME,URL,ICONCLASS,SID,AID) 
	select NEXTVAL('CORE_SEQUENCE'), 0, false, '1002', false, name, url, iconclass, id, 0 from BC_IDENTITY_RESOURCE where name='系统反馈';


-- 插入全局配置信息
insert into BC_DESKTOP_PERSONAL (ID,STATUS_,INNER_,FONT,THEME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false, '12', 'smoothness');

-- 插入浏览器附件下载信息
insert into BC_DOCS_ATTACH (ID,FILE_DATE,STATUS_,PTYPE,PUID,SIZE_,EXT,APPPATH,SUBJECT,PATH,AUTHOR_ID)
	select NEXTVAL('CORE_SEQUENCE'), now(), 1, 'browser', 'chrome14.0.835.186', 24610040,'exe',false
...
insert into BC_DOCS_ATTACH (ID,FILE_DATE,STATUS_,PTYPE,PUID,SIZE_,EXT,APPPATH,SUBJECT,PATH,AUTHOR_ID)
	select NEXTVAL('CORE_SEQUENCE'), now(), 1, 'browser', 'firefox7.0', 13891928,'exe',false
	,'火狐浏览器Firefox7.0.exe','browser/firefox/firefox7.0.exe',
	(select b.id from BC_IDENTITY_ACTOR a inner join BC_IDENTITY_ACTOR_HISTORY b on b.actor_id=a.id where a.code='admin');
insert into BC_DOCS_ATTACH (ID,FILE_DATE,STATUS_,PTYPE,PUID,SIZE_,EXT,APPPATH,SUBJECT,PATH,AUTHOR_ID)
	select NEXTVAL('CORE_SEQUENCE'), now(), 1, 'browser', 'safari5.1', 37806960,'exe',false
	,'苹果浏览器Safari5.1.exe','browser/safari/safari5.1.exe',
	(select b.id from BC_IDENTITY_ACTOR a inner join BC_IDENTITY_ACTOR_HISTORY b on b.actor_id=a.id where a.code='admin');
insert into BC_DOCS_ATTACH (ID,FILE_DATE,STATUS_,PTYPE,PUID,SIZE_,EXT,APPPATH,SUBJECT,PATH,AUTHOR_ID)
	select NEXTVAL('CORE_SEQUENCE'), now(), 0, 'browser', 'opera11.50', 10309696,'exe',false
...
BEGIN 
	LOOP
		...
		insert into BC_LOG_SYSTEM (ID,TYPE_,FILE_DATE,SUBJECT,AUTHOR_ID,C_IP,S_IP,C_INFO) 
			select NEXTVAL('CORE_SEQUENCE'), 0,now(),concat(a.name,'登录系统',i),b.id,'127.0.0.1','localhost','Chrome12'
